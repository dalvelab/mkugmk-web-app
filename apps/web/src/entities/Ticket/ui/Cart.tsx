  ...
  return (
    selected.length > 0 ? (
      <Flex
        ...
        flexDir="column"
      >
        <Heading as="h6" fontSize='2xl' fontWeight="semibold">Выбрано</Heading>
        <chakra.span mt={1} fontSize="xs" color="brand.gray">количество билетов можно будет выбрать далее</chakra.span>
        <Grid 
          pt={4} 
          pb={4} 
        ...
        >
          {selectedCenters.map((exhibition_center) => {
            if (exhibition_center.type === 'other' && isExhibitionCenterSelected) {
              return null;
            }
         ...
         (
          ...
          >
            <Flex flexDir="column" gap={2}>
              <chakra.span fontSize="xs" color="brand.gray">автоматически включено</chakra.span>
