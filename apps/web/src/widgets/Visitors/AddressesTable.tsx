      ...
      {data.map(({id, name, address}, index) => {
        ...
        return (
          <Flex
            ...
            borderRight={["none", "none", "none", `${borderRight}`, `${borderRight}`]}
            borderTop={[`${borderTop}`, `${borderTop}`, `${borderTop}`, "none", "none"]}
            borderColor={["brand.border", "brand.border", "brand.border", "brand.border", "brand.border"]}
