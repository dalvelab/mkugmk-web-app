...
export interface ApiBenefitsPageBenefitsPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    type_for_meilisearch: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
      ...
      Schema.Attribute.DefaultTo<'benefit-tickets-page'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiCafeAndSouvenirsPageCafeAndSouvenirsPage
  ...
  attributes: {
    ...
    type_for_meilisearch: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'cafe-and-souvenirs'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiComplexOperationManagementComplexOperationManagement
  ...
  attributes: {
    common_operating_hours: Schema.Attribute.Component<
      'shared.working-time',
      true
    > &
      Schema.Attribute.SetPluginOptions<{
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    special_days_operating_hours: Schema.Attribute.Component<
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    website_top_warning: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiContactsPageContactsPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    contacts: Schema.Attribute.Component<'contacts.department-contact', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    sell_exhibitions_offer_email: Schema.Attribute.Email &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiExhibitionCenterExhibitionCenter
  ...
  attributes: {
    additional_center: Schema.Attribute.DynamicZone<
    ...
    excursion_phone: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    is_excursion_available: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    publishedAt: Schema.Attribute.DateTime;
    ticket_sale_enabled: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
      ...
      Schema.Attribute.DefaultTo<true>;
    type: Schema.Attribute.Enumeration<['exhibition_center', 'other']> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
      ...
      Schema.Attribute.DefaultTo<'exhibition_center'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    working_time: Schema.Attribute.Component<'shared.working-time', true> &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    youtube_gallery: Schema.Attribute.Component<'shared.youtube-video', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiFaqPageFaqPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    questions_with_answers: Schema.Attribute.Component<'faq.faq', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    contacts: Schema.Attribute.Component<'footer.contact', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiInteractivePlaygroundPageInteractivePlaygroundPage
  ...
  attributes: {
    ...
    type_for_meilisearch: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'interactive-playground'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiNavigationPageNavigationPage
  extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    complex_map: Schema.Attribute.Media<'images'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPartnersPagePartnersPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    >;
    partners: Schema.Attribute.Component<'shared.info-card', true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiRulesPageRulesPage extends Struct.SingleTypeSchema {
...
export interface ApiTicketTicket extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    exhibition_centers: Schema.Attribute.Relation<
      ...
      'api::exhibition-center.exhibition-center'
    >;
    infotech_link: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    publishedAt: Schema.Attribute.DateTime;
    pushkin_card: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiTicketsPageTicketsPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    >;
    main_services: Schema.Attribute.Component<'visitors.main-services', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    other_services: Schema.Attribute.Component<'visitors.other', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiWelcomePageWelcomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    video_preview: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiWorkingHoursPageWorkingHoursPage
  extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    type_for_meilisearch: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'working-hours'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
